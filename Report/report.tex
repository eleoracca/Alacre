...
Infine vengono proposti dei confronti di ricostruzione in presenza di diverso livello di rumore. Sono state lanciate quattro analisi con livelli di rumore crescente: 0 punti di rumore presenti oppure 10/50/100 punti di rumore per layer. In \figurename~\ref{RumoreRismolt} si può osservare come varia la risoluzione dell'apparato in funzione della molteplicità all'aumentare del rumore sui due layer, mentre in \figurename~\ref{RumoreRisz} viene riportato il confronto della risoluzione dell'apparato all'aumentare del rumore in funzione della posizione del vertice dell'evento.
\begin{figure}[h!]
  \centering
  \mbox{
   \begin{minipage}[1]{.47\textwidth}
